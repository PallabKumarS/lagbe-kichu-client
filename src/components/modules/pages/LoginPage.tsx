...
const LoginPage = () => {
  ...
  const backgroundVariants: BackgroundVariants = {
    login: {
      background: [
        "linear-gradient(135deg, hsl(215, 80%, 55%) 0%, hsl(170, 70%, 45%) 100%)",
        "linear-gradient(135deg, hsl(170, 70%, 45%) 0%, hsl(215, 80%, 55%) 100%)",
      ],
    },
    register: {
      background: [
        "linear-gradient(135deg, hsl(260, 60%, 65%) 0%, hsl(215, 80%, 55%) 100%)",
        "linear-gradient(135deg, hsl(215, 80%, 55%) 0%, hsl(260, 60%, 65%) 100%)",
      ],
    },
  } as const;
